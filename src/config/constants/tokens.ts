...
const { ETHEREUM, BSC_MAINNET, BSC_TESTNET, POLYGON, FANTOM, AVALANCHE, CRONOS, BRISE } = ChainId
...
export const tokens = {
  ...
  [ChainId.BSC_MAINNET]: {
    ...
    fuse: new Token(BSC_MAINNET, '0x5857c96DaE9cF8511B08Cb07f85753C472D36Ea3', 18, 'FUSE', 'Fuse Token', 'https://fuse.io/'),
    ertha: new Token(
      BSC_MAINNET,
    ...
    era: new Token(BSC_MAINNET, '0x6f9F0c4ad9Af7EbD61Ac5A1D4e0F2227F7B0E5f9', 18, 'ERA', 'Era Token', 'https://www.era7.io/'),
    duet: new Token(
      BSC_MAINNET,
    ...
    pex: new Token(BSC_MAINNET, '0x6a0b66710567b6beb81A71F7e9466450a91a384b', 18, 'PEX', 'PearDAO', 'https://peardao.io/'),
    tinc: new Token(
      BSC_MAINNET,
    ...
    ceek: new Token(BSC_MAINNET, '0xe0F94Ac5462997D2BC57287Ac3a3aE4C31345D66', 18, 'CEEK', 'CEEK', 'https://www.ceek.com/'),
    abnbc: new Token(
      BSC_MAINNET,
...
export const brewsToken = {
  ...
  [ChainId.BSC_TESTNET]: tokens[ChainId.BSC_TESTNET].cake,
  [ChainId.POLYGON]: tokens[ChainId.POLYGON].usdc,
  [ChainId.FANTOM]: tokens[ChainId.FANTOM].usdc,
  [ChainId.AVALANCHE]: tokens[ChainId.AVALANCHE].usdc,
  [ChainId.CRONOS]: tokens[ChainId.CRONOS].usdc,
...
export const quoteTokens = {
  [ChainId.ETHEREUM]: [
    tokens[ChainId.ETHEREUM].usdc,
    tokens[ChainId.ETHEREUM].usdt,
    tokens[ChainId.ETHEREUM].brews
  ],
  [ChainId.BSC_MAINNET]: [
...
export const serializeTokens = (chainId: ChainId): SerializedTokenList => {
  const unserializedTokens = tokens[chainId]
