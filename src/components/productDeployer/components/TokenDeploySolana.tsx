...
const TokenDeploySolana = () => {
    ...
    }, [walletPublicKey, connection, tokenDecimals, tokenDescription,
        tokenImage, tokenImmutable, tokenName, tokenRevokeFreeze, tokenRevokeMint, tokenTotalSupply, tokenSymbol, umi.uploader, sendTransaction]);
