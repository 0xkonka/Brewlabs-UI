...
const getTokenLogoURL = (
  ...
  return appId === AppId.APESWAP
    ...
    : appId === AppId.PANCAKESWAP || tokenSymbol?.toLocaleLowerCase() === 'brewlabs' || tokenSymbol?.toLocaleLowerCase() === 'usdt'
      ...
      : appId === AppId.SUSHISWAP
        ...
        : `${ASSET_PATH}/${CHAIN_KEYS[chainId]}/assets/${address}/logo.png`
