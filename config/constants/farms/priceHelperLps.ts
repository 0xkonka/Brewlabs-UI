...
export const priceHelperLps: SerializedFarmConfig[] = [
   ...
   */
  {
    ...
    token: tokens[ChainId.BSC_MAINNET].dexi,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    chainId: ChainId.BSC_MAINNET,
    ...
    token: tokens[ChainId.BSC_MAINNET].dxg,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].bbft,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].pch,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].bacca,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].mair,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].ukrriseup,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].dox,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].busdm,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].dwt,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].dvfb,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].bully,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].gdt,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].eft,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].freedom,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].cvt,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].reflex,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].tarp,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].vantage,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].ego,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].ethfan,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].efb,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].balto,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].btiV2,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].bcat,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].cty,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].drmclub,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].h2on,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].vfx,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].dr,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].mfx,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].lung,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].heros,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].prox,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.BSC_MAINNET].roo,
    quoteToken: tokens[ChainId.BSC_MAINNET].wbnb,
  },
  // ethereum
  {
    ...
    token: tokens[ChainId.ETHEREUM].usdt,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    chainId: ChainId.ETHEREUM,
    ...
    token: tokens[ChainId.ETHEREUM].shari,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].saitama,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].koaCombat,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].shaman,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].ethdox,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].honr,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].shift,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].titn,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].scard,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].voltz,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].dryp,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].kpets,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].shift2,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].flip,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].reit,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].trt,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].jigsaw,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].heros,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].roo,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    token: tokens[ChainId.ETHEREUM].mmtkn,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  {
    pid: null,
    ...
    lpAddress: "0xcf3F1359013a002FD97735275101543D34E89d7c",
    token: tokens[ChainId.ETHEREUM].alcazar,
    quoteToken: tokens[ChainId.ETHEREUM].weth,
  },
  // polygon
  {
    ...
    token: tokens[ChainId.POLYGON].usdc,
    quoteToken: tokens[ChainId.POLYGON].wmatic,
  },
  {
    pid: null,
    chainId: ChainId.POLYGON,
    ...
    token: tokens[ChainId.POLYGON].mtbc,
    quoteToken: tokens[ChainId.POLYGON].wmatic,
  },
  // fantom
  {
    ...
    token: tokens[ChainId.FANTOM].usdc,
    quoteToken: tokens[ChainId.FANTOM].wftm,
  },
  // avax
  {
    pid: null,
    ...
    token: tokens[ChainId.AVALANCHE].usdc,
    quoteToken: tokens[ChainId.AVALANCHE].wavax,
  },
  // cronos
  {
    pid: null,
    ...
    token: tokens[ChainId.CRONOS].usdc,
    quoteToken: tokens[ChainId.CRONOS].wcro,
  },
  // brise
  {
    pid: null,
    ...
    token: tokens[ChainId.BRISE].usdt,
    quoteToken: tokens[ChainId.BRISE].wbrise,
  },
];
